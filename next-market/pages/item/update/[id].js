...
const UpdateItem = (props) =>{
    ...
    const handleSubmit = async(e)=>{
        e.preventDefault();
        try{
            const response = await fetch(`https://first-full-stack-git-main-kkatsumis-projects.vercel.app/api/item/update/${props.singleItem._id}`, {
                method: "PUT",
                headers:{
...
export const getServerSideProps = async(context) => {
    ...
    const response = await fetch(`https://first-full-stack-git-main-kkatsumis-projects.vercel.app/api/item/${context.query.id}`);
